#!/bin/sh
KAFKA=bootstrap.servers=b-2.abel-perf-test.c0k8cs.c2.kafka.ap-northeast-2.amazonaws.com:9092,b-1.abel-perf-test.c0k8cs.c2.kafka.ap-northeast-2.amazonaws.com:9092
ZOOKEEPER=z-1.abel-perf-test.c0k8cs.c2.kafka.ap-northeast-2.amazonaws.com:2181,z-2.abel-perf-test.c0k8cs.c2.kafka.ap-northeast-2.amazonaws.com:2181,z-3.abel-perf-test.c0k8cs.c2.kafka.ap-northeast-2.amazonaws.com:2181
INSTANCE=m5.xlarge
INDEX=$(seq 1 4)
for i in $INDEX
do
